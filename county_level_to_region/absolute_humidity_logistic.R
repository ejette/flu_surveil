...
source('~/repos/flu_surveil/county_level_to_region/datelookup.R')
source('~/repos/flu_surveil/county_level_to_region/format_fips.R')
...
load('/Users/jette/flu_surveil_data/all_humidity_agg.Rda')
...
# merge in counties
load('/Users/jette/flu_surveil_data/counties.Rda')
load('/Users/jette/flu_surveil_data/cities.Rda')
load('/Users/jette/flu_surveil_data/county_FIPS_xwalk.Rda')
...
counties_hum_fips = unique(counties_hum_fips[,c('absolute_humidity','FIPS_code')])
save(counties_hum_fips, file = '~/flu_surveil_data/counties_hum_fips.Rda')

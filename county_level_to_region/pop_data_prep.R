...
county_pop <- read.csv("~/flu_surveil_data/PEP_2012_PEPANNRES (1)/PEP_2012_PEPANNRES.csv", colClasses=c(rep("character",3),  rep("numeric",5)))
city_pop <- read.csv("~/flu_surveil_data/PEP_2011_PEPANRGCT.US23PR/PEP_2011_PEPANRGCT.US23PR.csv")

# load FIPS look up table
FIPS <- read.csv("~/flu_surveil_data/FIPS_CountyName.csv", header=F, colClasses = c(rep("character",2)))
...
census_2010_to_2012_raw<-read.csv("~/flu_surveil_data/CBSA-EST2012-01.csv", header=F, stringsAsFactors = FALSE)
...
save(county_w_pop, file = '/Users/jette/flu_surveil_data/county_w_pop.Rda')
